<x-head>
    ...
    <section class="ResExtResDevCont">
        ...
        <div class="ResExtResDevBot">
            <a class="ResExtResDevBotBtn" href="../page/ResDev.php">See More <img src="../images/Arrow 2.png" alt=""></a>
        </div>
    </section>
    ...
    <section class="ResExtServCont">
        ...
        <div class="ResExtServBot">
            <a class="ResExtServBotBtn" href="../page/Ext.php">See More <img src="../images/Arrow 2.png" alt=""></a>
        </div>
    </section>
    ...
    <section class="ResExtResDevCont">
        <div class="ResExtResDevTop">
            ...
            <p class="ResExtResDevTopText inter-light">Western Mindanao State University (WMSU) actively cultivates external linkages through initiatives like the Sibika Hub for civic education, the BATAS program for legal awareness, and international partnerships, demonstrating its commitment to community engagement and global collaboration;</p>
        </div>
        <div class="ResExtResDevBot">
            <a href="../page/linkages.php" class="ResExtResDevBotBtn">See More <img src="../images/Arrow 2.png" alt=""></a>
        </div>
    </section>
