...
<section class="ResExtResDevCont">
    ...
    <div class="ResExtResDevBot">
        <a class="ResExtResDevBotBtn" href="../page/ResDev.php">See More <img src="../imgs/Arrow 2.png" alt=""></a>
    </div>
</section>
...
<section class="ResExtServCont">
    ...
    <div class="ResExtServBot">
        <a class="ResExtServBotBtn" href="../page/Ext.php">See More <img src="../imgs/Arrow 2.png" alt=""></a>
    </div>
</section>
...
<section class="ResExtResDevCont">
    ...
    <div class="ResExtResDevBot">
        <a href="../page/linkages.php" class="ResExtResDevBotBtn">See More <img src="../imgs/Arrow 2.png" alt=""></a>
    </div>
</section>
