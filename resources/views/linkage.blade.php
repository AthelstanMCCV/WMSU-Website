<x-head>
   ...
   <section class="ero-hero">
    ...
    <section class="internation-exchange-program">
        <div class="iep-cont">
            <div class="circ-cont">
                <div><img src="../images/ero-iep-globe.png" alt=""></div>
            </div>
    ...
    <section class="our-global-network">
        ...
        <div class="ogn-cont">
            <div><img src="../images/partners-map.png" alt=""></div>
            <div class="ogn-label">
    ...
    <section class="featured-partners">
        ...
        <div class="featured-partners-cont"> 
            <div class="featured-partners-box-left">
                <div class="featured-partners-top"><img src="../images/ero-huawei.png" alt=""></div>
                <div class="featured-partners-bot">
                    ...
                    <div class="featured-partners-bot-text3">
                        ...
                        <img src="../images/ero-arrow.png" alt="">
                    </div>
            ...
            <div class="featured-partners-box-right">
                <div class="featured-partners-top"><img src="../images/ero-seamo-innotech.png" alt=""></div>
                <div class="featured-partners-bot">
                    <div class="featured-partners-bot-text1">
    ...
    <section class="linkages-partnership-statistic">
        ...
        <div class="linkages-partnership-statistic-cont">
            ...
            <div class="linkages-partnership-statistic-box">
                <div class="linkages-partnership-statistic-box-top"><img src="../images/ero-stat-internation-partners-img.png" alt=""></div>
                    <div class="lps-icon-cont">
                        <div class="lps-icon-icon"><img src="../images/ero-stat-international-partners-icon.png" alt=""></div>
                    </div>
            ...
            <div class="linkages-partnership-statistic-box">
                <div class="linkages-partnership-statistic-box-top"><img src="../images/ero-stat-overall-partners-img.png" alt=""></div>
                    <div class="lps-icon-cont">
                        <div class="lps-icon-icon"><img src="../images/ero-stat-overall-partners-icon.png" alt=""></div>
                    </div>
                <div class="linkages-partnership-statistic-box-bot">
            ...
            <div class="linkages-partnership-statistic-box">
                <div class="linkages-partnership-statistic-box-top"><img src="../images/ero-stat-national-partners-img.png" alt=""></div>
                    <div class="lps-icon-cont">
                        <div class="lps-icon-icon"><img src="../images/ero-stat-national-partners-icon.png" alt=""></div>
                    </div>
                <div class="linkages-partnership-statistic-box-bot">
    ...
    <!-- Search -->
     <div class='search-subsect'>
        <div class="search-container-and-icon">
            <div class='search-icon'><img src="../images/icon-search.png" alt=""></div>
    ...
    <section class="become-a-partner">
        <div class="become-a-partner-container">
            <div class="partner-left">
                ...
                <div class="director-img"><img src="../images/sir-mario.png" alt=""></div>
            </div>
            ...
            <div class="partner-right">
                ...
                <div class="icon-left-quote"><img src="../images/icon-left-quote.png" alt=""></div>
                <div class="icon-right-quote"><img src="../images/icon-right-quote.png" alt=""></div>
            </div>
        </div>
    </section>
</x-head>