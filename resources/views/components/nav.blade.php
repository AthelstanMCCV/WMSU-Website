<section class="navSectionCont">
    <div class="navSection h-full flex justify-between items-center mx-5">
        <div class="navLogo&TitleCont h-full flex items-center">
            ...
            <div class="navTitle">
                <p class="inter-bold text-base text-[#BD0F03]">WESTERN MINDANAO STATE UNIVERSITY</p>
                <p class="montserrat-regular text-xs text-[#BD0F03] -mt-1">A Smart Research University by 2040</p>
            </div>
        ...
        <div class="navLinksCont h-full flex items-center opacity-0 pointer-events-none absolute xl:opacity-100 xl:pointer-events-auto xl:relative ">
            ...
            <a class="MyWmsuBtn inter-regular text-xs py-2 px-7 ml-5 bg-[#BD0F03] border border-white text-white  hover:bg-white hover:text-[#BD0F03] hover:border-[#BD0F03] duration-300 ease-in-out" href="/signin">MyWMSU</a>
        </div>

        <div class="fixed top-[98px] right-8 z-50">
            <button class="bg-[white] hover:bg-[white]  text-white px-7 py-2 rounded-b-[100px] shadow-lg transition-all duration-300 ease-in-out transform hover:translate-y-2">
                <img src="{{ asset('images/search-icon.png') }}" alt="Search" class="h-3 w-3 -mt-1">
            </button>
        </div>

        <!-- Hamburger of Mobile and Tablet View -->
        <button class="menu hidden xl:opacity-0 xl:pointer-events-none xl:absolute opacity-100 pointer-events-auto relative" onclick="this.classList.toggle('opened');this.setAttribute('aria-expanded', this.classList.contains('opened'))" aria-label="Main Menu" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" >
        ...
        <!-- Drawer -->
        <div id="drawer-navigation" class="fixed top-28 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
