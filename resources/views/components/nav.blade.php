...
>>>>>>> Stashed changes
     ...
     <!-- Drawer -->
     <div id="drawer-navigation" class="fixed top-28 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-red-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
